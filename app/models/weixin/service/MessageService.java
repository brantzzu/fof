...
import models.weixin.resp.BaseMessage;
import models.weixin.resp.MediaMessage;
import models.weixin.resp.MusicMessage;
import models.weixin.resp.NewsMessage;
import models.weixin.resp.TextMessage;
import models.weixin.resp.VideoMessage;
...
public class MessageService {
	...
	public static String bulidSendMessage(Object obj, String msgType) {
		...
		// 图文消息处理
		if (msgType == Constant.RESP_MESSAGE_TYPE_NEWS) {
